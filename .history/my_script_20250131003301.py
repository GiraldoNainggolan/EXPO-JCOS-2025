...
video_path = "D:\EXPO JCOS 2025\SMA 4 JAKARTA.mp4"  # Ganti dengan path video di Kaggle

# Buat folder untuk menyimpan gambar hasil ekstraksi
output_folder = r"D:\EXPO JCOS 2025\crame"  # menggunakan raw string (r sebelum string)
